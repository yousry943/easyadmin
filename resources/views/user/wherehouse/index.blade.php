    ...
    <section class="site-data-container">
        <div class="site-data-wrapper">
            ...
            <div class="add-item-btn">
                    <a href="{{url('/create_wherehouse')}}" class="save">
                              ...
                              @foreach($wherehouse as $where)
                                <tr>
                                    ...
                                    <a href="bal7a">
                                        ...
                                        <td><span>{{$where->code}}</span></td>

                                        <td class="ellipsisOne"><span>{{$where->name}}</span></td>
                                        <!-- <td class="ellipsisTwo"><span>{{$where->desc}}</span></td> -->
                                        <td class="ellipsisThree">
                                            <span>{{$where->oppening_balance}}</span>
                                        </td>
                                        <td>
                                            <div class="item-action">

                                              <a href="{{url('/editwherehouse') . '/' .$where->id }}">  <div><i class="fas fa-edit"></i><span>edit</span></div></a>
                                              <a href="{{url('/deletewherehouse') . '/' .$where->id }}">  <div class="itemActionRed"><i class="far fa-trash-alt"></i><span>delete</span></div></a>
                                            </div>
                                        </td>
