...
<form action="{{url('/updatewherehouse/'.$wherehouses->id)}}" method="post">
            {{csrf_field()}}
            <div class="site-data-wrapper">
                <div class="data-title-search-container">
                        ...
                        <div class="billInputs flexBetween">
                            <div class="billInputsLeft">
                                ...
                                <div class="flexBetween billOpject">
                                    ...
                                    <input type="text" name="code" value="{{$wherehouses->code}}"></div>
                                @if ($errors->has('code'))
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $errors->first('code') }}</strong>
                                </span>
                                ...
                                <div class="flexBetween billOpject">
                                    ...
                                    <input type="text" name="name" value="{{$wherehouses->name}}">
                                </div>
                                <div class="flexBetween billOpject">
                                    <label for="">CONTACT FOR DELIVERIES</label>
                                    <input type="text" name="contact_delviery" value="{{$wherehouses->contact_delviery}}">
                                </div>
                                <div class="flexBetween billOpject">
                                    <label for=""> Openning balance</label>
                                    <input type="number" name="oppening_balance" value="{{$wherehouses->oppening_balance}}">
                                </div>
                                ...
                                <div class="flexBetween billOpject"><label for="">ADDRESS</label><textarea
                                        name="address" rows="4">{{$wherehouses->address}}</textarea></div>
                            </div>
                            ...
                            <div class="billInputsRight">
                                <div class="flexBetween billOpject"><label for="">TELEPHONE NO</label>
                                <input name="tel"  type="text" value="{{$wherehouses->tel}}"></div>
                                @if ($errors->has('tel'))
                                <span class="invalid-feedback d-block" role="alert">
                                ...
                                <div class="flexBetween billOpject"><label for="">SECONDRY PHONE NUMBER</label><input
                                        name="second_tel" type="text" value="{{$wherehouses->second_tel}}"></div>


                                <div class="flexBetween billOpject"><label for="">Fax NO</label>
                                    <input name="fax" type="text" value="{{$wherehouses->fax}}"></div>
                                @if ($errors->has('fax'))
                                <span class="invalid-feedback d-block" role="alert">
                                ...
                                <div class="flexBetween billOpject"><label for="">E-MAIL</label>
                                    <input name="email" type="text" value="{{$wherehouses->email}}">
                                </div>
                                @if ($errors->has('email'))
                                <span class="invalid-feedback d-block" role="alert">
