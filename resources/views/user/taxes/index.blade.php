        ...
        <div class="site-data-wrapper">
            ...
            <div class="flexBetween bagntion">
                <div class="add-item-btn">
                    <a href="{{('createtax')}}" class="save"><span><i class="fas fa-plus-circle fs-3x"></i></span>Add New</a>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <a href="bal7a">
                                        ...
                                        <td class="ellipsisOne"><span>{{$tax->description}}</span></td>
                                        <td class="ellipsisTwo"><span>{{$tax->rate}}%</span></td>
                                        <td>
                                            <div class="item-action">
                                                <a href="{{url('/edittax/' . $tax->id )}}"><div><i class="fas fa-edit"></i><span>edit</span></div></a>
                                                <a href="{{url('/deletetax/ '  .$tax->id) }}"><div class="itemActionRed"><i class="far fa-trash-alt">  <span>   delete</span></i></div></a>
                                            </div>
                                        </td>
                                    </a>
                                </tr>
