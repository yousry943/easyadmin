...
@foreach($Receive_Items as $reciveItem)
...
<tr>
    <a href="bal7a">
        ...
        <td><span>{{$reciveItem->refernce}}</span></td>

        <td class="ellipsisOne"><span>{{$reciveItem->vendor->name}}</span></td>
        <td class="ellipsisTwo"><span>{{$reciveItem->SCHEDUALE_DATE}}</span></td>
        <td class="ellipsisThree">
            <span>?</span>
        </td>
        <td class="ellipsisFour"><a href="{{url('/editpurchecedOrder/'.$reciveItem->purchase_order_id)}}" style="color:black">see purchase order</a></td>
        <td class="ellipsisFive"><span>{{$reciveItem->OPERATION_TYPE}}</td>
        <td>
            <div class="item-action">
<!--                <div><i class="fas fa-edit"></i><a href="{{url('editreciveItem/'.$reciveItem->id)}}">edit</a></div>-->
            <!-- <div class="itemActionRed"><i class="far fa-trash-alt"></i><a href="{{url('/deletereciveItem'.$reciveItem->id)}}">delete</a></div> -->
</div>
</td>
<td>
<!-- 8-justForGrid -->
