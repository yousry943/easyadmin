            ...
            <table id="myTable" class="box-data-table">
                ...
                <tbody>
                    <tr class="transactionRow">
                        ...
                        <td class="depit-transaction">10</td>
                    ...
                    <tr class="transactionRow">
                        <a href="bal7a">
                            ...
                            <td><span class="ellipsisOne">journal id</span></td>
                            <td class="depit-transaction"><span class="ellipsisTwo">0</span></td>
                            <td class="credit-transaction">
                                <span class="ellipsisThree ">40</span>
                            </td>
                    ...
                    <tr class="transactionRow">
                        <a href="bal7a">
                            ...
                            <td><span class="ellipsisOne">journal id</span></td>
                            <td><span class="ellipsisTwo depit-transaction">10</span></td>
                            <td>
                                <span class="ellipsisThree credit-transaction">0</span>
                            </td>
                            <td class="total-balance">
                                <span>
                                    0
                    ...
                    <tr class="transactionRow">
                        <a href="bal7a">
                            ...
                            <td><span class="ellipsisOne">journal id</span></td>
                            <td><span class="ellipsisTwo depit-transaction">0</span></td>
                            <td>
                                <span class="ellipsisThree credit-transaction">20</span>
                            </td>
                            <td class="total-balance">
                               <span>0</span>
                            </td>
                    ...
                    <tr class="transactionRow">
                        <a href="bal7a">
                            ...
                            <td><span class="ellipsisOne">journal id</span></td>
                            <td><span class="ellipsisTwo depit-transaction">50</span></td>
                            <td>
                                <span class="ellipsisThree credit-transaction">0</span>
                            </td>
