                ...
                <div class="data-title-search-container">
                    ...
                    <div class="bagntion flex">
                        <div class="add-item-btn">
                            <button class="save" name="draft" type="submit">Save</button>
            ...
            <div class="site-sections-wrapper flex">
                <div class="leftPart">
                    ...
                    <div class="box-data-container">
                        ...
                        <p>Serial number:</p><input type="text" name="serial_number">
                        ...
                        <div class="billInputs flexBetween">
                            <div class="billInputsLeft">
                                ...
                                <div class="flexBetween billOpject">
                                    ...
                                    <input type="text" name="vendor_referance">
                                </div>
                            ...
                            <div class="billInputsRight">
                                ...
                                <div class="flexBetween billOpject">
                                    ...
                                    <input type="date" name="bill_due_date">
                                </div>
                            ...
                            <table>
                                ...
                                <tbody class="bodySelection">
                                    <tr class="items accounts">
                                        ...
                                        <td><input type="text" name="qnty[]" class="quantity" placeholder="0"></td>
                                        <td><input type="text" name="unit_price[]" id="unitPrice" class="unitPrice"
                                                placeholder="0.00">
                                        <td><input type="text" name="price_item[]" id="price" class="price"
                                                placeholder="0.00">

                                        <td class="tax-con">
                                            <select class="tax" name="tax_id[]">
                                                @foreach($taxs as $tax)
                                                <option value="{{$tax->id}}">
                                                    {{$tax->name}}
                                                </option>
				...
				<select name="tax_id">
					<option>
						choose unit of measure
                                        ...
                                        <td>
                                            <button type="button" class="deleteAccountRow d-none"><i
                                ...
                                <div id="totalcon" class="totalcon">
                                    <div id="untaxedamount">
                                        ...
                                        <span class="total-value">
                                            ...
                                            <span class="finalTotalValueUnTaxed">
                                                0.00
                                            </span>
                                            <input name="untaxedtotal" type="hidden" id="getUntaxedTotal">
                                            </span>
                                    </div>
                                    <div id="taxes">
                                        <span class="total-name">
                                        ...
                                        <span class="total-value">
                                            ...
                                            <input name="tax" type="hidden" id="getTaxes">
                                        </span>
                                    </div>
                                </div>
