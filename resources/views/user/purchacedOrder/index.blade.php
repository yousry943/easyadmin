                ...
                @foreach($purchaseOrder as $purchaseOrder)
                    <tr>
                        <a href="bal7a">
                         ...
                         <td class="ellipsisSix"><span> {{$purchaseOrder->exluded}} </span></td>
                          <td class="ellipsisSeven"><span>{{$purchaseOrder->tax}}</span></td>
                          <td class="ellipsisEight"><span> {{$purchaseOrder->total}}</span></td>
                          <td class="ellipsisNine"><span> {{$purchaseOrder->paid}} </span></td>
                          <td class="ellipsisTen"><span>{{$purchaseOrder->to_pay}} </span></td>
                        ...
                        <li><a href="{{url('postinvoice/'.$purchaseOrder->id)}}">make it post</a></li>
                         ...
                         <li><a href="{{url('/ReturnPurchase/'.$purchaseOrder->id)}}">Return</a></li>
