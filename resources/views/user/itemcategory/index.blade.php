        ...
        <div class="site-data-wrapper">
            ...
            <div class="flexBetween bagntion">
                <div class="add-item-btn">
                    <a href="{{url('/createItemCategory')}}" class="save"><span><i class="fas fa-plus-circle fs-3x"></i></span>Add New</a>
                </div>
            ...
            <div class="site-sections-wrapper">
                <div class="box-data-container">
                    ...
                    <th><span class="ellipsisAction">Action</span></th>
                            ...
                            <tbody>
                                @foreach($item_categories as $item_categories)
                                <tr>
                                    <a href="bal7a">
                                        <td class="checkNum">
                                        ...
                                        <td><span>{{$item_categories->category_name}}</span></td>

                                        <td class="ellipsisOne"><span>{{$item_categories->category_description}}</span></td>
                                        <td>
                                              <div class="item-action">
                                                <a href="{{url('/editItemCategory') . '/' .$item_categories->id }}"><div><i class="fas fa-edit"></i><span>edit</span></div></a>
                                                <a href="{{url('/deleteItemCategory') . '/' .$item_categories->id }}"><div class="itemActionRed"><i class="far fa-trash-alt">  <span>   delete</span></i></div></a>
                                            </div>
                                        </td>
                                        <td>
                                            <!-- 8-justForGrid -->
