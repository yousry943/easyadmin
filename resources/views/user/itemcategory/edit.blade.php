...
<body>
  ...
  @include('user.includes.header')
     ...
     <section class="site-data-container accountingForm ItemForm ItemCategoryForm">
        <form action="{{url('/updateItemCategory') . '/' .$item_category->id }}" method="post">
            {{csrf_field()}}
        ...
        <div class="site-sections-wrapper flex">
            <div class="leftPart">
                    ...
                    <div class="billInputs flexBetween">
                        <div class="billInputsLeft">
                                <div class="flexBetween billOpject"><label for="">Category Name</label><input
                                        type="text" name="category_name" value="{{$item_category->category_name}}"></div>
                ...
                <div class="billInputsRight">
                       <div class="flexBetween billOpject"><label for="">Category descreption</label><input type="text" name="category_description" value="{{$item_category->category_description}}"></div>
