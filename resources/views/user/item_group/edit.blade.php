...
<body>
  ...
  <section class="site-data-container accountingForm ItemForm ItemCategoryForm">
        <form action="{{url('/item_group/update/'.$item_group->id)}}" method="post">
        {{csrf_field()}}
        ...
        <div class="site-sections-wrapper flex">
            <div class="leftPart">
                ...
                <div class="flexBetween billOpject"><label for="">Category Name</label>
                <input type="text" name="name" value="{{$item_group->group_name}}" placeholder="Category Name">
                @if ($errors->has('name'))
            ...
            <div class="billInputsRight">
                ...
                <textarea name="desc" rows="4" placeholder="Category Description">
                {{$item_group->group_description}}
                </textarea>
