        ...
        <div class="site-data-wrapper">
            ...
            <div class="flexBetween bagntion">
                <div class="add-item-btn">
                    <a href="{{url('/createItem')}}" class="save"><span><i class="fas fa-plus-circle fs-3x"></i></span>Add
                        New</a>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <a href="bal7a">
                                        ...
                                        <td class="ellipsisFour"><span><a class="ellipsisLink" href="{{url('/viewItemtranscation/'. $item->id)}}">{{$item->	transcation}}</a></span></td>
                                        <td class="ellipsisFive"><span><a href="{{url('/viewItemtranscation/'. $item->id)}}" class="ellipsisLink">
