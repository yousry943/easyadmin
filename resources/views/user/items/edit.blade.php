...
<body>
  ...
  @include('user.includes.header')
    <section class="site-data-container accountingForm ItemForm">
        <form method="post" action="{{url('/updateItem') . '/' .$item->id }}" enctype="multipart/form-data">
        {{csrf_field()}}
                    ...
                    <div class="box-data-container">
                        ...
                        <div class="billInputs flexBetween">
                            <div class="billInputsLeft">
                                <div class="flexBetween billOpject"><label for="">Item Code</label><input type="text" name="code" value="{{$item->code}}">
                                    <!-- <span><i class="fas fa-caret-down"></i></span> -->
                                </div>
                                <div class="flexBetween billOpject"><label for="">Item Name</label><input type="text" name="name" value="{{$item->name}}">
                                    <!-- <span><i class="fas fa-caret-down"></i></span> -->
                                </div>
...
<!--                                </div>-->
                                ...
                                <div class="flexBetween billOpject"><label for="">DESCRIPTION</label><textarea
                                        rows="4" name="desc">{{$item->desc}}</textarea><!-- <span><i class="fas fa-caret-down"></i></span> -->
                                </div>
                                ...
                                <div class="flexBetween billOpject"><label for="">Serial Number</label><input type="text" name="serial_number" value="{{$item->Serial_Number}}"><!-- <span><i class="fas fa-caret-down"></i></span> -->
                                </div>
                                <div class="flexBetween billOpject"><label for="">Part Number</label><input type="text" name="part_number" value="{{$item->Part_Number}}">
                                    <!-- <span><i class="fas fa-caret-down"></i></span> -->
                                </div>
                            ...
                            <div class="billInputsRight">
                                ...
                                <select name="Location_id">
                                        ...
                                        <option  value="{{$location->id}}">{{$location->name}}-{{@$location->wherehous->first()->name}}</option>
                                        @endforeach

                                    </select>
                                </div>
                                <div class="flexBetween billOpject"><label for="">Opening  Price balance</label><input
                                        type="number" name="price" value="{{$item->price}}"><!-- <span><i class="fas fa-caret-down"></i></span> -->
                                </div>
                                <div class="flexBetween billOpject"><label for="">Opening Quantity balance</label><input
                                        type="number" name="Quantity" value="{{$item->Quantity}}"><!-- <span><i class="fas fa-caret-down"></i></span> -->
                                </div>
